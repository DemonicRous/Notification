let Notification = function() {
    ...
    // Основные настройки Нотификации
    var r = {
        types: [ {
            type: "success",
        ...
        t && ((e = t.node).classList.add("notification__toast--disappear"), e.addEventListener(this.animationEndEventName, i = function(t) {
        ...
        return e && (t = i.classList).add.apply(t, e.split(" ")), this.container.appendChild(i),
            i;
        ...
        var e = this._createHTMLElement({
            ...
            tagName: "div",
            className: "notification__ripple"
        ...
        "object" == typeof i && (p = i.tagName, d = i.className, l = i.text, i = void 0 === (i = i.color) ? u : i,
            l = this._createHTMLElement({
                tagName: void 0 === p ? "i" : p,
                className: d,
                text: l
            }), i && (l.style.color = i), c.appendChild(l)), a.appendChild(c)), a.appendChild(r),
            e.appendChild(a), u && (t.ripple ? (s.style.background = u, e.appendChild(s)) : e.style.background = u),
        t.dismissible && (s = this._createHTMLElement({
            tagName: "div",
            className: "notification__dismiss"
        }), u = this._createHTMLElement({
            tagName: "button",
            className: "notification__dismiss-btn"
        }), s.appendChild(u), a.appendChild(s), e.classList.add("notification__toast--dismissible"),
        ...
        return e.classList.add("notification__toast--" + t), e;
        ...
        var t = this._createHTMLElement({
            tagName: "div",
            className: "notification-announcer"
        });
        t.setAttribute("aria-atomic", "true"), t.setAttribute("aria-live", "polite"), t.style.border = "0",
            t.style.clip = "rect(0 0 0 0)", t.style.height = "1px", t.style.margin = "-1px",
            t.style.overflow = "hidden", t.style.padding = "0", t.style.position = "absolute",
            t.style.width = "1px", t.style.outline = "0", document.body.appendChild(t), this.a11yContainer = t;
    ...
    function p() {
        ...
        t.appendChild(i), document.body.appendChild(t), this.container = i, this.animationEndEventName = this._getAnimationEndEventName(),
    ...
    return d.prototype.error = function(t) {
        ...
        t = this.normalizeOptions("warn", t);
        return this.open(t);
        ...
        return "string" == typeof i ? t.message = i : "object" == typeof i && (t = o(o({}, t), i)),
            t;
